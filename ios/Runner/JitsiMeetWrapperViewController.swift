//
//  JitsiMeetWrapperViewController.swift
//  Runner
//
//  Created by Tabish Sangrar on 25/05/23.
//
...
class JitsiMeetWrapperViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.eventSink([JitsiMeetEventStreamHandlerEvent.dataKey: JitsiMeetEventStreamHandlerEvent.onConferenceInitialize])
...
extension JitsiMeetWrapperViewController: JitsiMeetViewDelegate {
    func ready(toClose data: [AnyHashable : Any]) {
        ...
        self.eventSink([JitsiMeetEventStreamHandlerEvent.dataKey: JitsiMeetEventStreamHandlerEvent.onReadyToClose])
    }
    
    func conferenceJoined(_ data: [AnyHashable : Any]) {
        self.eventSink([JitsiMeetEventStreamHandlerEvent.dataKey: JitsiMeetEventStreamHandlerEvent.onConferenceJoined])
      
      
    }
    
    func conferenceTerminated(_ data: [AnyHashable: Any]) {
        self.eventSink([JitsiMeetEventStreamHandlerEvent.dataKey: JitsiMeetEventStreamHandlerEvent.onConferenceTerminated])
    }
    
    func conferenceWillJoin(_ data: [AnyHashable : Any]) {
        self.eventSink([JitsiMeetEventStreamHandlerEvent.dataKey: JitsiMeetEventStreamHandlerEvent.onConferenceWillJoin])
    }
    ...
    func participantJoined(_ data: [AnyHashable : Any]) {
        self.eventSink([JitsiMeetEventStreamHandlerEvent.dataKey: JitsiMeetEventStreamHandlerEvent.onPictureInPictureWillEnter])
    }
    
    func participantLeft(_ data: [AnyHashable : Any]) {
        self.eventSink([JitsiMeetEventStreamHandlerEvent.dataKey: JitsiMeetEventStreamHandlerEvent.onPictureInPictureTerminated])
    }
